...
СТРОГО: правки — только перестановка и переформулировка того, что в CV уже есть.
...
Оценку ставь по сути роли, а не по числу совпавших слов: другое направление —
это низкий балл, даже если отдельные технологии в описании встречаются.
