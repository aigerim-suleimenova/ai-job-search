...
TR = {
    ...
    "results_live_done": {"ru": "Поиск закончился — обновить список", "en": "The search has finished — refresh the list", "it": "La ricerca è finita — aggiorna l'elenco", "de": "Die Suche ist fertig — Liste aktualisieren"},
