...
TR = {
    ...
    "app_behavior": {"ru": "⚙️ Поведение программы", "en": "⚙️ App behaviour",
                     "it": "⚙️ Comportamento del programma", "de": "⚙️ Verhalten des Programms"},
    ...
    "models_only_fits": {"ru": "только те, что пойдут на этом устройстве",
                         "en": "only ones this device can run",
                         "it": "solo quelli che il dispositivo può eseguire",
                         "de": "nur solche, die dieses Gerät ausführen kann"},
